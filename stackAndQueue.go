...
func updateMatrix(mat [][]int) [][]int {
	...
	for len(stack) > 0 {
		...
		//上
		if point[0]-1 >= 0 {
			if value := mat[point[0]-1][point[1]]; value == -1 {
				mat[point[0]-1][point[1]] = mat[point[0]][point[1]] + 1
				stack = append(stack, []int{point[0] - 1, point[1]})
			}
		}
		//下
		...
		//左
		if point[1]-1 >= 0 {
			if value := mat[point[0]][point[1]-1]; value == -1 {
				mat[point[0]][point[1]-1] = mat[point[0]][point[1]] + 1
				stack = append(stack, []int{point[0], point[1] - 1})
			}
		}
		//右
		if point[1]+1 < xLength {
			if value := mat[point[0]][point[1]+1]; value == -1 {
				mat[point[0]][point[1]+1] = mat[point[0]][point[1]] + 1
				stack = append(stack, []int{point[0], point[1] + 1})
			}
